...
import { setIsActionActive, setActiveActionIndex } from "../../store/slices/appAlice";
...
`;
function StickerSettings({ style, onChanges }) {
...
const ImageShadows = ({ setSteps, activeObjectProps }) => {
  ...
  const handleColorPickerClick = () => {
    if (
      ...
      activeObjectProps.type === "sticker"
    ) {
